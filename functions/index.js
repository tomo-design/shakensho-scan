...
【法人向けLP】機能・料金・導入の流れ・FAQ・資料請求フォームをまとめたページ → https://mechanoai-cablueie.com/biz.html （相手に詳細を見てもらう時はここへ誘導）。
...
4. 本文末尾に、必ず下記の【送信者情報・配信停止】ブロックをそのまま記載する（削除・改変しない）。これが無いと違法。
5. URLは「アプリ体験・詳細はこちら」等と書く。お問い合わせ先はメール（署名内）。虚偽の実績・数値は書かない。

【送信者情報・配信停止（そのまま末尾に付ける）】
――――――――――――
本メールは、貴社が公開されている連絡先へ、整備業向けツールのご案内としてお送りしています。
今後の配信を希望されない場合は、本メールに「配信停止」とご返信ください。以後お送りしません。

メカノAI（MECHANO-AI）
提供：Cablueie（カブリエ）　担当：中江 智広
〒894-0062 鹿児島県奄美市名瀬有屋町36-2
TEL：080-3692-0101　Mail：cablueie.123@gmail.com
アプリ体験・詳細：https://mechanoai-cablueie.com/
――――――――――――`;
