...
function buildStepImagePrompt(stepText, carName) {
  return [
    "自動車整備マニュアルの『作業手順イラスト』を1枚生成してください。最重要: 車の外観カタログ写真ではなく、その作業を“今まさに行っている動作”が一目で分かる図にすること。",
    "描くもの: 整備士の手と工具が、作業対象の部品にどう当たり・どう動かすかを近距離で示す。必要なら矢印で動作方向を示す。",
    "スタイル: 清潔感のある半写実イラスト(教本の挿絵風)。やわらかい陰影、わかりやすい色分け。背景は薄く簡素にして作業部位を目立たせる。",
    "禁止: 車全体の外観・テールランプ・エンブレムなどの“車種が分かるだけ”の絵、文字/ロゴ/透かし、過度な誇張。",
    "車種名は雰囲気の参考程度にとどめ、作業内容の描写を最優先する。",
    "作業内容(これを描く): " + stepText,
  ].join("\n");
}
