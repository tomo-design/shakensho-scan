...
const SUPPORT_KB = [
  ...
  "",
  "【概要】整備士向けアプリ。車検証をスキャンして車両を識別し、メンテナンス諸元・AI故障診断・修理手順・整備カルテを現場で使える。データは端末内に保存。契約店舗は社内の全端末で自動共有。個人向けの「MECHANO-AI Pocket」(Google Play)は7日無料→月額¥500。法人向けは「MECHANO-AI Works」。",
  ...
  "【MECHANO-AI Pocket（個人向け・Google Play）】ダウンロード無料、最初の7日間は全機能無料、8日目以降は月額¥500(アプリ内サブスク)。ログイン不要で使える。",
  "【困った時】『AIが混み合っています』は少し時間をおいて再試行。諸元が遅い/出ない時は『最新に更新』や個別🔄、契約店舗はプラン有効期限を確認。データは端末を削除すると消えるので大切な記録は控えを。アプリが古い時は設定下部『アプリを最新に更新』(MECHANO-AI Pocketはストア更新)。",
